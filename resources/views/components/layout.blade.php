        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <x-nav-my-link href="/" :active="request()->is('/')">Home</x-nav-my-link>
              <x-nav-my-link href="/jobs" :active="request()->is('jobs')">Jobs</x-nav-my-link>
              <x-nav-my-link href="/contact" :active="request()->is('contact')">Contact</x-nav-my-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            @guest
              <x-nav-my-link href="/login" :active="request()->is('login')">Log In</x-nav-my-link>
              <x-nav-my-link href="/register" :active="request()->is('register')">Register</x-nav-my-link>
            @endguest
            @auth
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            ...
            <div class="text-sm font-medium text-gray-400">peter@example.com</div>
          </div>
